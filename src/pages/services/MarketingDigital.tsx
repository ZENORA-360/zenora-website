...
import { Icon3DMegaphone } from "@/components/icons/Zenora3DIcons";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <PageCTA
          ...
          lead={t("marketing.cta.description")}
